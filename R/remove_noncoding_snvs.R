...
##' @author whtns
##' @export
remove_noncoding_snvs <- function(noncoding_all_study_snvs) {
  ...
  noncoding_snv_consequence <- c("exon", "EXON", "silent", "SILENT", "UTR_3", "UTR_5", "synonymous_variant", "non_coding_transcript_exon_variant", "intron_variant", "3_prime_UTR_variant", "5_prime_UTR_variant", "?")
  ...
  coding_snv_consequence <- c("frameshift", "frameshift deletion", "frameshift insertion",
                              ...
                              "NONSENSE", "nonsynonymous SNV", "nonsynonyrnous SNV", "splice site substitution", "inframe_insertion", "inframe_deletion", 
