...
```{r setup}
knitr::opts_chunk$set(dev = c("png", "pdf"), fig.path="figures/", results="hide", warning = FALSE, message)
...
for (i in lollipop_genes){
  lollipopPlot(maf = merged_maf, gene = i, AACol = 'HGVSp_Short', showMutationRate = TRUE, showDomainLabel = FALSE, labelPos = 'all')
}
dev.off()
```
