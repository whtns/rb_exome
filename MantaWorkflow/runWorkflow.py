#!/usr/bin/env python
# Workflow run script auto-generated by command: '/home/skevin/TOOLS/manta-1.2.1.centos6_x86_64/bin/configManta.py --normalBam=output/picard/49-N_1_removed_duplicates.bam --tumorBam=output/picard/49-T_1_removed_duplicates.bam --exome --referenceFasta=../Homo_sapiens/UCSC/hg19/Sequence/WholeGenomeFasta/genome.fa'
#

import os, sys

scriptDir=os.path.abspath(os.path.dirname(__file__))
sys.path.append(r'/home/skevin/TOOLS/manta-1.2.1.centos6_x86_64/lib/python')
...
main(r"/dataVolume/storage/rb_pipeline/MantaWorkflow/runWorkflow.py.config.pickle","manta",MantaWorkflow)
